...
#'   Returns a [data.table::data.table()] with fields "key", "label", "param_classes", "properties" and "packages" as
#'   columns.
...
#' tnr("random_search")
mlr_tuners = R6Class("DictionaryTuner", inherit = Dictionary, cloneable = FALSE)$new()
