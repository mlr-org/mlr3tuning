...
ObjectiveTuningAsync = R6Class("ObjectiveTuningAsync",
  ...
  private = list(
    .eval = function(xs, resampling) {
      ...
      private$.resample_result = resample(self$task, self$learner, self$resampling, store_models = FALSE, allow_hotstart = TRUE, clone = character(0), callback = self$callbacks)
