...
#' @keywords internal
#' @export
TunerBatchFromOptimizerBatch = R6Class(
  ...
  public = list(
    ...
    #' The single evaluations and the final results will be written into the [ArchiveBatchTuning] that resides in the
    ...
    optimize = function(inst) {
      ...
      if (
        !inst$search_space$length && !is.null(inst$internal_search_space) && !test_class(self, "TunerBatchInternal")
      ) {
