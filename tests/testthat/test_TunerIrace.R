...
test_that("paradox_to_irace no dependencies", {
  ...
  expect_irace_parameters(
    parameters = paradox_to_irace(ps), names = "lgl", types = "c",
  ...
  expect_irace_parameters(
    parameters = paradox_to_irace(ps),
    names = c("dbl", "int", "fct", "lgl"),
    types = c("r", "i", "c", "c"),
    domain = list(
      dbl = c(0.1, 0.3), int = c(1, 9), fct = c("a", "b", "c"),
      lgl = c("TRUE", "FALSE")))
  ...
  expect_irace_parameters(
    ...
    types = c("c", "i", "r", "i", "c"),
    domain = list(
      fct = c("a", "b", "c"), int1 = c(1, 9), dbl = c(0.1, 0.3),
...
test_that("paradox_to_irace dependencies", {
  ...
  expect_irace_parameters(
    parameters = paradox_to_irace(ps), names = c("a", "b"), types = c("c", "i"),
  ...
  expect_irace_parameters(
    parameters = paradox_to_irace(ps), names = c("a", "c", "b"),
    types = c("c", "c", "i"),
  ...
  expect_irace_parameters(
    parameters = paradox_to_irace(ps), names = c("a", "b", "c", "d"),
    types = c("c", "i", "c", "r"),
    domain = list(
...
test_that("TunerIrace works with logical params", {
  ...
  inst = TuningInstanceSingleCrit$new(
    tsk("mtcars"), lrn("regr.rpart"), rsmp("holdout"),
    msr("regr.mse"),
