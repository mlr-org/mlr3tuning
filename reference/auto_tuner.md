...
[AutoTuner](https://mlr3tuning.mlr-org.com/reference/AutoTuner.md) to
...
[mlr3::Resampling](https://mlr3.mlr-org.com/reference/Resampling.html)
passed to the
[AutoTuner](https://mlr3tuning.mlr-org.com/reference/AutoTuner.md) is
meant to be the inner resampling, operating on the training set of an
...
[AutoTuner](https://mlr3tuning.mlr-org.com/reference/AutoTuner.md) fails
when a row id of the inner resampling is not present in the training set
of the outer resampling.
