...
`on_optimizer_queue_after_eval` stages to `CallbackAsyncTuning`. fix:
Add loaded packages to objective. feat: Add tiny logging. fix: Remove
internal search space and trafo error. fix: Unsatisfied dependencies in
...
- fix: The [`ti()`](https://mlr3tuning.mlr-org.com/reference/ti.md)
...
- fix: `AutoTuner` did not accept `TuningSpace` objects as search
  spaces.
- feat: Add [`ti()`](https://mlr3tuning.mlr-org.com/reference/ti.md)
...
- feat: Allow to pass `Tuner` objects as `method` in
  [`tune()`](https://mlr3tuning.mlr-org.com/reference/tune.md) and
  [`auto_tuner()`](https://mlr3tuning.mlr-org.com/reference/auto_tuner.md).
...
- [`tune()`](https://mlr3tuning.mlr-org.com/reference/tune.md) supports
...
- Adds [`tune()`](https://mlr3tuning.mlr-org.com/reference/tune.md),
  [`auto_tuner()`](https://mlr3tuning.mlr-org.com/reference/auto_tuner.md)
  and
  [`tune_nested()`](https://mlr3tuning.mlr-org.com/reference/tune_nested.md)
  sugar functions.
