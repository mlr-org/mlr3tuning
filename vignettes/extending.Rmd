...
1. Use the [`mlr3tuning::TunerFromOptimizer`](#tuner-from-optimizer) class to transform the `Optimizer` to a `Tuner`.
...
The `mlr3tuning::TunerFromOptimizer` class transforms a `Optimizer` to a `Tuner`.
