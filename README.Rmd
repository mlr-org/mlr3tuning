...
We optimize a support vector machine on the [Sonar](https://mlr3.mlr-org.com/reference/mlr_tasks_sonar.html) data set as a small example here.
We tune the the `cost` and `gamma` hyperparameter.
